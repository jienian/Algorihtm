...
public void reverse() {
    ...
    Node before = null; // 初始化前一个节点为null
    ...
    while (temp != null) {
        ...
        temp.next = before; // 将当前节点的指针指向前一个节点，实现反转
        before = temp;      // 移动前一个节点的指针到当前节点
        temp = after;       // 移动当前节点的指针到下一个节点
    }

    head = before; // 完成遍历后，before指针将指向原始链表的尾节点，现在成为新的头节点
}
